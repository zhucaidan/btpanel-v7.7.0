...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 http://btpanel.jdbug.cn/btpanel/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 http://btpanel.jdbug.cn/btpanel/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt http://btpanel.jdbug.cn/btpanel/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh http://btpanel.jdbug.cn/btpanel/install/public.sh -T 10
	wget -O panel.zip http://btpanel.jdbug.cn/btpanel/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt http://btpanel.jdbug.cn/btpanel/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh http://btpanel.jdbug.cn/btpanel/install/src/bt7.init -T 10
