...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://cdn.jsdelivr.net/gh/ztkink/bthappy@main/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/ztkink/bthappy@main/bt6.init -T 10
	...
	wget -O panel.zip https://cdn.jsdelivr.net/gh/ztkink/bthappy@main/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://cdn.jsdelivr.net/gh/ztkink/bthappy@main/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://cdn.jsdelivr.net/gh/ztkink/bthappy@main/bt7.init -T 10
